...
For a square grid of size N, given input is k = N^2 - 1. Using Manhattan distance as a heuristic, find the shortest solution using IDA* if one exists, otherwise print out -1.
